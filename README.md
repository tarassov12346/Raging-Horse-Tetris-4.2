...
* `/snapShot` — Инициирует рендеринг игрового поля через Playwright, последовательно обновляет скриншоты в MongoDB и рассчитывает статус рекорда с использованием блокировок на методе `.join()`.
